...
const addScoreToSkill = async (session: SessionState["session"], skill: Skill, score: number, callback: (payload: {skill: Skill, score: number}) => void) => {
...
export default addScoreToSkill;